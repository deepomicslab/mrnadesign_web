<template>
    <div class="h-680 flex flex-col py-5 px-20">
        <div class="flex flex-row ml-1 my-7">
            <div class="text-4xl font-600">Anti-CRISPR Proteins Information</div>
...
onBeforeMount(async () => {
    loading.value = true
    loading.value = true
    const response = await axios.get(`/anticrispr/`, {
        baseURL: '/api',
        timeout: 100000,
    })
...
const viewdetail = async (row: any) => {
    ...
    const response2 = await axios.get(`/phage/protein/`, {
        ...
        timeout: 100000,
        params: {
            phageid: anticrisprInfo.value.Phage_Acession_ID,
            proteinid: anticrisprInfo.value.Protein_id,
        },
    })
    const proteindata = response2.data
    anticrisprInfo.value.protein = proteindata
    ...
    },
    {
        title() {
            return renderTooltip(
                ...
                'source of the anti-CRISPR protein annotation'
            )
        },
        key: 'Source',
        align: 'center',
