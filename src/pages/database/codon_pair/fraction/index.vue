<template>
    <div class="h-320 flex flex-col py-10 px-30">
        <div class="flex flex-row ml-1 my-7">
            <div class="text-4xl font-600">Codon Pair Fraction</div>
...
const downloadlink = ref(
    'https://mrnaapi.deepomics.org/codon_pair/fraction/download/?calculation_type=fraction&&tissue=ALL'
)
