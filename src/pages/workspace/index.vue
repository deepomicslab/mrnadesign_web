...
const viewdetail = (row: any) => {
    if (row.status === 'Success') {
        ...
        } else if (row.analysis_type === 'Prediction') {
            router.push({
        ...
        } else if (row.analysis_type === 'Safety') {
            router.push({
        ...
        } else if (row.analysis_type === 'Sequence Align') {
            router.push({
        ...
        } else if (row.analysis_type === 'Antigen Screening') {
            router.push({
        ...
        } else if (row.analysis_type === 'TCR Alpha-Beta Chain Pairing') {
            router.push({
