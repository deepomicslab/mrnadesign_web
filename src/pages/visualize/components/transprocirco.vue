<template>
    <div class="h-240">
        ...
        <!-- <div class="w-310 h-30 bg-gray-200 flex justify-center">
            <svg id="Legend_transprotein" height="120" width="1140"></svg>
        </div> -->
    </div>
</template>
...
const transprotein = computed(() => {
    return phageStore.phagetransprotein
})
...
watch(loaded, () => {
    ...
    _.map(transpro, (d, i) => {
        ...
        if(!isNaN(parseInt(d.insidestart))){
            ...
            .attr('d', getSegmentPath(pro.Start_location, 
        ...
        if(inside){
            ...
            const mouseenter = function () {
                ...
                const startEndRad = getStartEndRad(pro.Start_location, 
                    d.insidestart, d.insideend)
                ...
                const textContent=[`Inside source: ${d.insidesource}`,
        ...
        if(tmHelix){
            ...
            const mouseenter = function () {
                ...
                const textContent=[`TMhelix source: ${d.TMhelixsource}`,
        ...
        if(outside){
            ...
            const mouseenter = function () {
                ...
                const textContent=[`Outside source: ${d.outsidesource}`,
