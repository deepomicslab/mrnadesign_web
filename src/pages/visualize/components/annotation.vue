<template>
    ...
    >
        ...
        <div class="flex flex-row text-xl">
            ...
            {{ Number(selectProteinData.Start_location) }}
        </div>
        <div class="flex flex-row text-xl">
            <p class="mr-3 font-bold">Stop:</p>
            {{ Number(selectProteinData.Stop_location) }}
        </div>
        <div class="flex flex-row text-xl">
        ...
        <div class="flex flex-row text-xl">
            <p class="mr-3 font-bold">Function classification:</p>
            {{ selectProteinData.Protein_function_classification }}
        </div>
        <div class="flex flex-row text-xl">
            <p class="mr-3 font-bold">Product:</p>
            {{ selectProteinData.Protein_product }}
        </div>
...
//     //             region[count - 1].end = proData.Stop_location
//     //         } else {
//     //             region[count] = {
//     //                 idlist: [proData.id],
...
//     //                 start: proData.Start_location,
//     //                 end: proData.Stop_location,
//     //             }
//     //             count += 1
//     //         }
//     //     } else {
